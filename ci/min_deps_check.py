"""Fetch from conda database all available versions of the regionmask dependencies and their
publication date. Compare it against requirements/py36_min_all_deps.yml to verify the
