...
latex_documents = [
  ('index', 'regionmask.tex', u'regionmask Documentation',
   u'Mathias Hauser', 'manual'),
]
...
man_pages = [
    ('index', 'regionmask', u'regionmask Documentation',
     [u'Mathias Hauser'], 1)
]
...
texinfo_documents = [
  ('index', 'regionmask', u'regionmask Documentation',
   u'Mathias Hauser', 'regionmask', 'One line description of project.',
   'Miscellaneous'),
]
